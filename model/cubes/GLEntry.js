cube(`g_l_entry`, {
  ...
  dimensions: {
    ...
    last_dim_correction_node: {
      sql: `${CUBE}."LAST_DIM_CORRECTION_NODE"`,
      type: `number`
    },
    fa_entry_type: {
    ...
    close_income_statement_dim_id: {
      sql: `${CUBE}."CLOSE_INCOME_STATEMENT_DIM_ID"`,
      type: `number`
    },
    last_dim_correction_entry_no: {
      sql: `${CUBE}."LAST_DIM_CORRECTION_ENTRY_NO"`,
      type: `number`
    },
    system_modified_by: {
